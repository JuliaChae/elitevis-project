  ...
  const waypoints = d3.selectAll('.step').each( function(d, stepIndex) {
    return new Waypoint({
      ...
      handler: function(direction) {
        console.log('Waypoint triggered for step index:', stepIndex);
      ...
      offset: '100%', // it's not simply an issue with the html not being long enough. it's still something with scrolly.
    });
  });
})
